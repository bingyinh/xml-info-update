...
##    while xsdDir == "":
##        xsdDir = raw_input("Please type in the directory of the xsd schema file:")
    csvDir = "E:/Dropbox/DIBBS/data_update/info_update_xml/schema/072618to081218.csv"
    xmlDir = "E:/Dropbox/DIBBS/data_update/info_update_xml/schema/forUpload060718_to_072618/"
    # schemaID = '5b1ebeb9e74a1d61fc43654d' # PNC_schema_060718
    schemaID = 'xml'
